...
@section('content')
    <div class="card rounded-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="/admin/them-moi/danh-muc" class="btn btn-dark waves-effect waves-light w-sm pt-2 pb-2">Thêm mới</a>
        </div>
    </div>
                ...
                <div class="table-responsive table-card mt-3 mb-1">
                    <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <tr>
                            ...
                            <th class="sort" data-sort="customer_name">Ảnh đại diện</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <div class="edit">
                                            <button onclick="window.location='/admin/{{$item->id}}/danh-muc'" class="btn btn-sm btn-success edit-item-btn" >Edit</button>
                                        </div>
                                        <div class="remove">
                                            <button
                                                value="{{ $item->id }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#delete-record').click(function () {
                ...
                form.attr('action', '/admin/'+ item_id+'/danh-muc');
                form.submit();
            });
        })
    </script>
