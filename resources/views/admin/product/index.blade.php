...
@section('content')
    <div class="card rounded-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="/admin/them-moi/san-pham" class="btn btn-dark waves-effect waves-light w-sm pt-2 pb-2">Thêm mới</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <div class="edit">
                                        <button onclick="window.location='/admin/{{$item->id}}/san-pham'" class="btn btn-sm btn-success edit-item-btn" >Edit</button>
                                    </div>
                                    <div class="remove">
                                        <button
                                            value="{{ $item->id }}"
